...
export const metadata: Metadata = {
  title: "Sign In | L'Échelon",
  description: "Sign in to your L'Échelon account to access the full editorial intelligence platform.",
}
    ...
    <div style={{
      ...
      <div style={{ textAlign: 'center', marginBottom: 40, position: 'relative', zIndex: 1 }}>
        ...
        <p style={{
          ...
          L&apos;Échelon · Luxury Editorial Intelligence
        </p>
      </div>
